...
public enum TestingErrorCode {
    ...
    NO_CDLF_FILE(1006,"No Cldf files corresponding to Mismo file"),
    ...
    INVALID_OPTIONAL_CONFIG_PROPERTY(1014,"The system config property is not a valid one.");
