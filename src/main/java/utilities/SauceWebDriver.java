...
public class SauceWebDriver {
    private static final String buildID = LocalConfUtils.getProperty("SauceBuildID");
    private static final String browser = LocalConfUtils.getProperty("browser");
    private static final String version = LocalConfUtils.getProperty("version");
    private static final String os = LocalConfUtils.getProperty("sauceBuildID");
    private static final String username = LocalConfUtils.getProperty("sauceUsername");
    private static final String accesskey = LocalConfUtils.getProperty("sauceKey");
    private static final String tunnelID = LocalConfUtils.getProperty("sauceTunnel");
    private static final String parentTunnelID = LocalConfUtils.getProperty("parentSauceTunnel");
    private static final String proxyHost = LocalConfUtils.getProperty("proxyHost");
    private static final String proxyPort = LocalConfUtils.getProperty("proxyPort");
